                ...
                <div class="box-body" style="border: 0px; padding-top:0px; ">
                  ...
                  <div class="col-lg-12 col-xs-12">
                    <div class="row nuevoProducto">
                      ...
                      <div class="flex">
                        <button type="button" class="btn btn-primary pull-right btn-agregar-carrito" data-toggle="modal" data-target="#modalProductosGuia"><i class="fas fa-cart-plus fa-lg"></i> Agregar Productos</button>
