                  ...
                  <div class="box" style="border: 0px; padding-top:0px;">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <div class="input-group-adddon">
                            <input type="text" class="form-control" id="ubigeo" name=" ubigeo" placeholder="Ingrese codigo de ubigeo" title="Ubigeo">
                            <!-- <span class="input-group-addon"><i class="fa fa-search"></i></span>  -->
                          </div>
                        </div>
                      </div>
                                  ...
                                  <td>
                                    ...
                                    <div class="form-group">
                                      <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" style="display: none" min="0" placeholder="0.00" id="descuentoGlobalP" name=" descuentoGlobalP" value="" placeholder="Ingrese descuento" style="display: none">
                            ...
                            <div class="table-responsive">
                              <table class="table  tabla-totales">
                                ...
                                <tbody class="totales">
                                  ...
                                  <tr class="op-descuento-item" style="display: none">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" id="formProductos" enctype="multipart/form-data">
        ...
        <div class="modal-header" style="background:#0e6edf; color:white">
          ...
          <h4 class="modal-title">NUEVO PRODUCTO O SERVICIO</h4>
