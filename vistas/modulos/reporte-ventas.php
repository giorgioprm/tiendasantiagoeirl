         ...
         <div class="row fechas-reportes">
          ...
          <!-- fin row fechas -->
             ...
             <div class="contenedor-radios">
                ...
                <label for="notac" class="btn-radios"><i class="fa fa-file-invoice"></i> Notas de Crédito</label>
                <input type="radio" id="notac" class="comp" name="tipocomp" value="07">
                <label for="notad" class="btn-radios"><i class="fa fa-file-invoice"></i> Notas de Débito</label>
