          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="nuevaCategoria" id="nuevaCategoria" onkeyup="this.value=NumText(this.value)" placeholder="Ingresar categoría" title="Categoría">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" id="editarCategoria" name="editarCategoria" value="" onkeyup="this.value=NumText(this.value)" title="Categoría" required>
