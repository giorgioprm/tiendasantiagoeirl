...
//Consultar los datos necesarios para mostrar en el PDF - FIN
    ...
    if($compra['tipocomp'] == '01'){
        $rucdni = $emisor['ruc'];
        $razons_nombre = $emisor['razon_social'];
        $tipodocemisor = 6;
     ...
     <tr>
         ...
         <td class="v35">
             ...
             <tr>               
               ...
               <td class="v50 b-r"><?php echo $tipoMoneda.$compra['op_gravadas'];?></td>
            </tr>        
           <tr>               
               <td>EXONERADAS:</td>
               <td><?php echo $tipoMoneda.$compra['op_exoneradas'];?></td>
          </tr>
           <tr>               
               <td>INAFECTAS:</td>
               <td><?php echo $tipoMoneda.$compra['op_inafectas'];?></td>
          </tr>
           <tr>               
               <td>GRATUITAS:</td>
               <td><?php echo $tipoMoneda.$compra['op_gratuitas'];?></td>
          </tr>
           <tr>               
               <td>DESCUENTO(-):</td>
           ...
           <tr>               
               <td>ICBPER:</td>
               <td><?php echo  $tipoMoneda.$compra['icbper'];?></td>
          </tr>
           <tr>               
               <td>IGV(18%):</td>
               <td><?php echo  $tipoMoneda.$compra['igv'];?></td>
          </tr>
           <tr>               
               <td>TOTAL:</td>
               <td><?php echo  $tipoMoneda.$compra['total'];?></td>
          </tr>
             </table>
         </td>
     </tr>          
