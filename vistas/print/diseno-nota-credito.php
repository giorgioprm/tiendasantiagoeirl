...
*/
 ...
 <table class="head"><tr>
         ...
         <h4 style="margin-botton:0px; font-size:15px"><?php echo $nota['serie'] . ' - ' .str_pad( $nota['correlativo'],6,"0",STR_PAD_LEFT); ?></h4></div>
         </td>
         </tr>
         </table>
         </div>
    ...
    <table  class="datos-cliente">
             <tr class="clie"><td style="width:30mm" class="first">FECHA DE EMISIÓN:</td><td style="width:148mm" class="last"><?php 
        ...
        $importe_total = ($fila['valor_unitario'] > 0) ? $fila['importe_total'] : number_format(0.00,2);             
             ...
             <td style="padding-left:12px"><?php echo   $tipoMoneda.' '.$importe_total; ?></td>
             ...
             $descuentosItems += $fila['descuento'];  
                   ...
                   $descuentos = round($nota['descuento'] + $descuentosItems,2);
             ?>
    ...
    <div style=";width:100%;margin:0">
     <table class="totales" style=";width:100%;margin:0;">
      <tr>
          ...
          <td style="width:25mm;padding-left:12px"><?php echo $tipoMoneda.' '.$nota['op_gravadas'];?></td>
      </tr>
         <tr>
          <td style="width:30mm;">Op. Exonerada:</td>
          <td style="width:25mm;padding-left:12px"><?php echo  $tipoMoneda.' '.$nota['op_exoneradas'];?></td>
      </tr>
         <tr>
          <td style="width:30mm;">Op. Inafectas:</td>
          <td style="width:25mm;padding-left:12px"><?php echo  $tipoMoneda.' '.$nota['op_inafectas'];?></td>
      </tr>
         <tr>
          <td style="width:30mm;">Op. Gratuitas:</td>
          <td style="width:25mm;padding-left:12px"><?php echo  $tipoMoneda.' '.$nota['op_gratuitas'];?></td>
      </tr>
         <tr>
          <td>Descuento:</td>
         ...
         <tr>
          <td>IGV(18.00%):</td>
          <td style="padding-left:12px"><?php echo  $tipoMoneda.' '.$nota['igv'];?></td>
      </tr>
         <tr>
          <td>Total:</td>
          <td style="padding-left:12px"><?php echo  $tipoMoneda.' '.$nota['total'];?></td>
      </tr>
  </table></div>  </td>
   </tr>
