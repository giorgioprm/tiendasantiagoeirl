...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    class HTML2PDF
    {
        ...
        protected $_format           = array(50,50);        // page format : A4, A3, ...
         ...
         */
        public function __construct($orientation = 'P', $format = array(50,50), $langue='es', $unicode=true, $encoding='UTF-8', $marges = array(5, 5, 5, 8))
        {
